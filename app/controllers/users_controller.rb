  ...
  def edit_basic_info
    @user = User.find(1)
      if params[:user].present?
        design_work_time = params[:user][:design_work_time]
        basic_work_time = params[:user][:basic_work_time]
        @user.update(design_work_time: design_work_time, basic_work_time: basic_work_time)
  ...
  private
    ...
    def user_params
      params.require(:user).permit(:name, :email, :password,:affiliation,
                                   :basic_work_time, :design_work_time, :password_confirmation,
